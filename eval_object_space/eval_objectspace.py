...
from env_object import BlockStackingEnv

# Create the environment
env = BlockStackingEnv()


def train_and_eval(model, env, eval_every=1000, total_learning_time=1000000):
    # Train the agent
...
# save the results
all_results.to_csv(f"block_stack_ppo_objectspace_{start_time}.csv")
